...
<head>
    ...
    <title>Tables — CaféHub Management System</title>
        ...
        <header class="topbar">
            ...
            <div style="display:flex; align-items:center; gap:15px;">
                ...
                <div class="page-title">
                    <h1>Tables</h1>
                    <p>Manage table status and capacity</p>
                </div>
            ...
            <div class="stats">
                ...
                <div class="stat-card">
                    ...
                    <div>
                        <h4>Reserved</h4>
                        <h2>1</h2>
                        <div class="stat-change" style="color:#a86b16;">
                            Table 3 · 6:30 PM
                        </div>
                    </div>
                ...
                <div class="tables-grid">
                    ...
                    <div class="table-card">
                        <div class="table-card-header">
                            ...
                            <div class="table-capacity">2 pax</div>
                        </div>
                        <div class="table-status">
                            <span class="status-pill status-occupied">Occupied</span>
                        </div>
                        <div class="table-customer"><strong>Maria Santos</strong></div>
                    ...
                    <div class="table-card">
                        <div class="table-card-header">
                            ...
                            <div class="table-capacity">4 pax</div>
                        </div>
                        <div class="table-status">
                    ...
                    <div class="table-card">
                        <div class="table-card-header">
                            ...
                            <div class="table-capacity">6 pax</div>
                        </div>
                        <div class="table-status">
                            <span class="status-pill status-reserved">Reserved</span>
                        </div>
                        <div class="table-customer"><strong>Reyes Party</strong></div>
                        <div class="table-actions">
                            <button class="btn btn-view">View</button>
                            <button class="btn btn-status">Change Status</button>
                        </div>
                    ...
                    <div class="table-card">
                        ...
                        <div class="table-customer"><strong>John Cruz</strong></div>
                        <div class="table-actions">
                            <button class="btn btn-view">View</button>
                            <button class="btn btn-status">Change Status</button>
                        </div>
                    ...
                    <div class="table-card">
                        <div class="table-card-header">
                            ...
                            <div class="table-capacity">8 pax</div>
                        </div>
                        <div class="table-status">
                            <span class="status-pill status-occupied">Occupied</span>
                        </div>
                        <div class="table-customer"><strong>Santos Family</strong></div>
                        <div class="table-actions">
                            <button class="btn btn-view">View</button>
                            <button class="btn btn-status">Change Status</button>
                        </div>
                    ...
                    <div class="table-card">
                        ...
                        <div class="table-status">
                            <span class="status-pill status-cleaning">Cleaning</span>
                        </div>
                        <div class="table-customer">&nbsp;</div>
                        <div class="table-actions">
                            <button class="btn btn-view">View</button>
                    ...
                    <div class="table-card">
                        ...
                        <div class="table-customer"><strong>Carlos Group</strong></div>
                        <div class="table-actions">
                            <button class="btn btn-view">View</button>
                            <button class="btn btn-status">Change Status</button>
                        </div>
                    ...
                    <div class="table-card">
                        <div class="table-card-header">
                            <div class="table-number">Table 9</div>
                            <div class="table-capacity">2 pax</div>
                        </div>
                        <div class="table-status">
                            <span class="status-pill status-available">Available</span>
                    ...
                    <div class="table-card">
                        ...
                        <div class="table-customer"><strong>Anna Reyes</strong></div>
                        <div class="table-actions">
                            <button class="btn btn-view">View</button>
                            <button class="btn btn-status">Change Status</button>
                        </div>
                    ...
                    <div class="table-card">
                        <div class="table-card-header">
                            <div class="table-number">Table 11</div>
                            <div class="table-capacity">8 pax</div>
                        </div>
                        <div class="table-status">
                            <span class="status-pill status-available">Available</span>
                    ...
                    <div class="table-card">
                        <div class="table-card-header">
                            <div class="table-number">Table 12</div>
                            <div class="table-capacity">4 pax</div>
                        </div>
                        <div class="table-status">
                            <span class="status-pill status-available">Available</span>
